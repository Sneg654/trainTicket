...
public class StartCollection {
    public static final Map<Integer, Ticket>getCollection(Map<Integer, Ticket>tickets){
        ...
        ticket1.setNumberTicket(TrainTicketJaxWsServersImpl.currentNumber++);
        ticket1.setStatusTicket(TrainTicketJaxWsServersImpl.BOOKED);
        ...
        ticket2.setNumberTicket(TrainTicketJaxWsServersImpl.currentNumber++);

        ticket2.setStatusTicket(TrainTicketJaxWsServersImpl.BOOKED);
        ...
        ticket3.setStatusTicket(TrainTicketJaxWsServersImpl.PAID);
